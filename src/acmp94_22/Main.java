...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        int n = Integer.parseInt(input("Введите число голов, которые меч срубает одним ударом: "));
        int m = Integer.parseInt(input("Введите число голов дракона: "));
        int k = Integer.parseInt(input("Введите число голов, которые дракон регенерирует за раз: "));
        if (n >= m){
            System.out.println("Принц убъет дракона за 1 удар");
        } else if (n <= k) {
            System.out.println("Принцу не удастся убить дракона");
        } else {
            System.out.println("Принц убъет дракона за " + (((m-n)/(n-k))+1) + " удар(а)/(ов)");
        }
